...
const RiskRating1 = ({ position ="mt-1 -ml-24" }) => {
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td className="border px-2 py-1 text-right">{">"} 615</td>
              </tr>
              <tr>
                <td className="border px-2 py-1">A</td>
                <td className="border px-2 py-1 text-right">615 - 649</td>
              </tr>
              <tr>
                <td className="border px-2 py-1">B</td>
                <td className="border px-2 py-1 text-right">650 - 679</td>
              </tr>

              <tr>
                <td className="border px-2 py-1">C</td>
                <td className="border px-2 py-1 text-right">680 - 709</td>
              </tr>
              <tr>
                <td className="border px-2 py-1">C-</td>
                <td className="border px-2 py-1 text-right">{"<"} 709</td>
              </tr>
            </tbody>
          </table>
        </div>
