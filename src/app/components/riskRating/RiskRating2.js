...
const RiskRating2 = ({ position ="mt-1 -ml-24" }) => {
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr>
                ...
                <td className="border px-2 py-1 text-right">{">"} 710</td>
              </tr>
              <tr>
                <td className="border px-2 py-1">B</td>
                <td className="border px-2 py-1 text-right">615 - 699</td>
              </tr>
              <tr>
                <td className="border px-2 py-1">C</td>
                <td className="border px-2 py-1 text-right">{">"} 699</td>
              </tr>
            </tbody>
          </table>
        </div>
